...
class ShoppingList extends Component {
    ...
    getIngredientList = () => {
        ...
        axios({
            method: 'get',
            url: "http://back-end/shopping-list/rest/ingredient/get/" + sessionStorage.getItem("username"),
            responseType: 'json'
        })
    ...
    clearList = () => {
        ...
        axios({
            method: 'delete',
            url: "http://back-end/shopping-list/rest/account/clear/" + sessionStorage.getItem("username"),
            responseType: 'json'
        })
            .then(function (response) {
                actuallyThis.setState({
