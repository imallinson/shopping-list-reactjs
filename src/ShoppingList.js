...
class ShoppingList extends Component {
    ...
    getIngredientList = () => {
        ...
        axios({
            method: 'get',
            url: "http://35.246.105.207:8080/shopping-list/rest/ingredient/get/" + sessionStorage.getItem("username"),
            responseType: 'json'
        })
    ...
    clearList = () => {
        ...
        axios({
            method: 'delete',
            url: "http://35.246.105.207:8080/shopping-list/rest/account/clear/" + sessionStorage.getItem("username"),
            responseType: 'json'
        })
            .then(function (response) {
                actuallyThis.setState({
