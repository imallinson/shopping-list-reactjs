...
class Ingredient extends Component {
    ...
    saveChange = () => {
        ...
        axios({
            method: 'put',
            url: "/back-end/shopping-list/rest/ingredient/update/" + this.props.ingredient.ingredientID,
            responseType: 'json',
            data: {
    ...
    deleteItem = () => {
        ...
        axios({
            method: 'delete',
            url: "/back-end/shopping-list/rest/ingredient/remove/" + this.props.ingredient.ingredientID,
            responseType: 'json'
        })
        .then(function () {
            actuallyThis.props.onUpdate();
